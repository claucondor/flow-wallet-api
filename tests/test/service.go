...
import (
	...
	"github.com/flow-hydraulics/flow-wallet-api/internal/datastore/gorm"
...
func GetServices(t *testing.T, cfg *configs.Config) Services {
	t.Cleanup(func() {
		goleak.VerifyNone(t,
			...
			goleak.IgnoreTopFunction("github.com/flow-hydraulics/flow-wallet-api/internal/jobs.(*WorkerPoolImpl).startWorkers.func1"),
			goleak.IgnoreTopFunction("github.com/flow-hydraulics/flow-wallet-api/internal/ops.(*workerPoolImpl).Start.func1"),
			goleak.IgnoreTopFunction("github.com/flow-hydraulics/flow-wallet-api/internal/jobs.(*WorkerPoolImpl).startDBJobScheduler.func1"),
			goleak.IgnoreTopFunction("github.com/flow-hydraulics/flow-wallet-api/internal/chain_events.(*ListenerImpl).Start.func1"),
		)
	})
